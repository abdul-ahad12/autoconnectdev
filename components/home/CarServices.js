  ...
  return (
    <div className='w-full flex justify-center items-center flex-col py-8'>
      <div className='w-[90%] flex justify-center'>
        <TitleDesc title={"Car Services"} titleColor={"We Provide"} desc={"What all we do for you "} />
      </div>
      {/* cards */}
      ...
      {/* bottom section */}
      <div className='mb-4 text-graycolor2 text-[1.3rem]'> Our experienced technicians provide reliable and consistent service for all your auto repair needs.</div>
      {/* Button */}
